...
export default function () {
  ...
  const email = `load-${__VU}-${__ITER}@synthetic.invalid`;
  const register = http.post(`${base}/api/v1/auth/register`, JSON.stringify({ email, username: `load_${__VU}_${__ITER}`, password: 'SyntheticLoadPassword123!', display_name: 'Synthetic' }), { headers: { 'Content-Type': 'application/json' } });
